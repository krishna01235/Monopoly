        ...
        <div class="center">
          <div class="game-info">
            <div class="turn-indicator">
              <font-awesome-icon :icon="['fas', 'user']" class="turn-icon" />
              <span class="turn-text">Turn: {{ currPLayer.name }}</span>
            </div>
            <div class="game-stats">
              <div class="stat-item">
                <font-awesome-icon :icon="['fas', 'users']" class="stat-icon" />
                <span>{{ board.players.length }} Players</span>
              </div>
              <div class="stat-item">
                <font-awesome-icon :icon="['fas', 'dollar-sign']" class="stat-icon" />
                <span>₹{{ currPLayer.balance.toLocaleString() }}</span>
              </div>
            </div>
          </div>
          
          <div class="game-controls">
            <button class="control-btn dice-btn" @click="throwDice">
              <font-awesome-icon :icon="['fas', 'dice']" class="btn-icon" />
              <span>Throw Dice</span>
            </button>
            <button class="control-btn pass-btn" @click="swichToNextPlayer">
