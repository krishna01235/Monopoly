...
async function main() {
    ...
    console.log("Deploying Monopoly contract with the account:", deployer.address);

    // Get the contract factory connected with the deployer signer
    const ContractFactory = await ethers.getContractFactory("Monopoly", deployer);
    ...
    console.log(`Monopoly contract deployed to: ${contractAddress}`);

    // Save contract details for the frontend
    saveFrontendFiles(contract, "Monopoly");
}
...
function saveFrontendFiles(contract, name) {
    ...
    console.log(`Monopoly contract artifacts saved to ${contractsDir}`);
}
